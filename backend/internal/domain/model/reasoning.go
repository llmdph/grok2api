...
//   - grok-4.5: low/medium/high/xhigh (Console now accepts xhigh; max stays guarded)
...
var grokReasoningCapabilities = map[string][]string{
	"grok-4.5":                     {ReasoningEffortLow, ReasoningEffortMedium, ReasoningEffortHigh, ReasoningEffortXHigh},
