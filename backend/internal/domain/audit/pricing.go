...
func buildOfficialTokenPrices() map[string]tokenPrice {
	...
	// grok-4.6 uses the same published token rates as grok-4.5 until xAI publishes a distinct schedule.
	register("grok-4.6", tokenPrice{InputTicks: 20000, CachedInputTicks: 3000, OutputTicks: 60000, LongContextTokens: 200000, LongInputTicks: 40000, LongCachedTicks: 6000, LongOutputTicks: 120000},
		"grok-4.6-latest")
