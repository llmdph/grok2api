...
function ModelRouteValue({ model, upstreamModel, reasoningEffort, account, clientKey, clientIp, requestId, provider, operation, sources }: {
  model: string;
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent className="w-72 max-w-[calc(100vw-2rem)] space-y-1.5 py-2" side="top" align="start">
        ...
        <RouteDetailRow label={t("audits.reasoningEffort")} value={effortLabel} />
