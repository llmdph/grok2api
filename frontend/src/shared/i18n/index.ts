  ...
  "zh-CN": {
    translation: {
      ...
      keys: {
        ...
        modelAliasesConsoleSupport: "Grok Console：grok-4.3 支持 none / low / medium / high；grok-4.20-0309-reasoning 为固定推理模式，不支持调节 effort；grok-4.20-multi-agent-0309 额外支持 xhigh。",
      ...
      docs: {
        ...
        endpointAudioTasks: "OpenAI 风格音频任务兼容路径，默认返回 JSON 封装结果。",
        ...
        reference: {
          ...
          noteAudioTasksCompat: "部分客户端使用 /v1/audio/tasks；本网关按 speech 同步处理，并默认返回 JSON 封装。",
  ...
  en: {
    translation: {
      ...
      docs: {
        ...
        endpointAudioTasks: "OpenAI-style audio task compatibility path that returns a JSON envelope by default.",
        ...
        reference: {
          ...
          noteAudioTasksCompat: "Some clients call /v1/audio/tasks. This gateway handles it synchronously like speech and returns a JSON envelope by default.",
