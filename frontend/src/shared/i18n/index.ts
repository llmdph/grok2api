    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldSTTModel: "转写模型公开 ID，通常为 grok-transcribe。",
          ...
          noteSTTModels: "转写模型使用 grok-transcribe；词级时间戳与说话人分离按请求参数返回。",
    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldSTTModel: "Public transcription model ID, usually grok-transcribe.",
          ...
          noteSTTModels: "Transcription uses grok-transcribe. Word timestamps and diarization follow the request parameters.",
